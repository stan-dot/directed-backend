...
class Cohorts(Base):
    ...
    school = Column(
        String,
        ForeignKey(Schools.name, ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
    )
...
class Students(Base):
    ...
    cohort = Column(
        String, ForeignKey(Cohorts.name, ondelete="SET NULL", onupdate="CASCADE")
    )
    school = Column(
        String,
        ForeignKey(Schools.name, ondelete="CASCADE", onupdate="CASCADE"),
...
class Milesones(Base):
    ...
    cohort_name = Column(
        String,
        ForeignKey(Cohorts.name, ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
        primary_key=True,
    )
